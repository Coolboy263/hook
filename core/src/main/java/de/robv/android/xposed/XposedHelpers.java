...
import org.apache.commons.lang3.ClassUtils1;
import org.apache.commons.lang3.reflect.MemberUtils1;

/**
 * Helpers that simplify hooking and calling methods/constructors, getting and settings fields, ...
 */
@SuppressWarnings({"unused", "CaughtExceptionImmediatelyRethrown", "SynchronizationOnLocalVariableOrMethodParameter"})
public final class XposedHelpers {
    ...
    public static Class<?> findClass(String className, ClassLoader classLoader) {
        ...
        try {
            return ClassUtils1.getClass(classLoader, className, false);
    ...
    public static Method findMethodBestMatch(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        ...
        do {
            for (Method method : clz.getDeclaredMethods()) {
                ...
                if (method.getName().equals(methodName) && ClassUtils1.isAssignable(parameterTypes, method.getParameterTypes(), true)) {
                    // get accessible version of method
                    if (bestMatch == null || MemberUtils1.compareParameterTypes(
    ...
    public static Constructor<?> findConstructorBestMatch(Class<?> clazz, Class<?>... parameterTypes) {
        ...
        for (Constructor<?> constructor : constructors) {
            // compare name and parameters
            if (ClassUtils1.isAssignable(parameterTypes, constructor.getParameterTypes(), true)) {
                // get accessible version of method
                if (bestMatch == null || MemberUtils1.compareParameterTypes(
