...
public class ClassUtils1 {
    ...
    public static Class<?> getClass(String className, boolean initialize) throws ClassNotFoundException {
        ...
        ClassLoader loader = contextCL == null ? ClassUtils1.class.getClassLoader() : contextCL;
    ...
    public static String getShortCanonicalName(String canonicalName) {
        return ClassUtils1.getShortClassName(getCanonicalName(canonicalName));
    }
    ...
    public static String getPackageCanonicalName(final String canonicalName) {
        return ClassUtils1.getPackageName(getCanonicalName(canonicalName));
    }
